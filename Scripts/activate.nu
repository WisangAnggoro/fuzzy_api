...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\User\Documents\ugm\polytron\fuzzy flask\flask'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\User\Documents\ugm\polytron\fuzzy flask\flask\Scripts\deactivate.nu'
